...
<body>
	...
	$columnName["2"] = "produk.id";
	$columnName["3"] = "produk.product_name";
	$columnName["4"] = "produk.product_price";
	$columnName["5"] = "produk.product_master_image";
	...
	<div class="page-wrapper">
		<header class="header" id="header">
			...
			<div class="header-bottom sticky-header fixed">
				<div class="container">
					<nav class="main-nav">
