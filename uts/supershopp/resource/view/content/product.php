...
$totalproduk = count($featuredResult);
## ===*=== [F]ETCH PRODUCT DATA FOR FEATURED PRODUCT SLIDER ===*=== ##
...
$onCondition["1"] = ["categories.id", "produk.category_id"];
$onCondition["2"] = ["subcategories.id", "produk.subcategory_id"];
$whereValue["produk.id"] = $_SESSION['SSCF_product_product_id'];
...
<main class="main">
	...
	<div class="container">
			...
			<aside class="sidebar-product col-lg-3 padding-left-lg mobile-sidebar">
				<div class="sidebar-wrapper">
					...
					<div class="widget widget-featured">
						<h3 class="widget-title">Featured produk</h3>
						<div class="widget-body">
							<div class="owl-carousel widget-featured-produk">
								...
								<?php 
										if(($j == '0' && $index > 0) || $index + 1 == $totalproduk) 
										{
								?>
		...
		<div class="featured-section">
			<div class="container">
				<h2 class="carousel-title">Relevant produk</h2>
				<div class="featured-produk owl-carousel owl-theme owl-dots-top">
					...
					<?php
						...
						foreach($relevantResult AS $eachrelevantProduct)
						{
							...
							<div class="product">
								<figure class="product-image-container">
									<a href="product.php?id=' .$eachrelevantProduct['id'] . ' " class="produk-image">
