...
$categoryDetails = $pageControl->fetchData('produk', 'subcategory_id', $_SESSION['category_subcategory_id']);
...
if (!empty($categoryDetails)) {
	...
	$cp = ($page - 1) * $rpp;
	$categoryDetails = $pageControl->paginateData('produk', 'subcategory_id', $_SESSION['category_subcategory_id'], $cp, $rpp);
...
$columnName["1"] = "kategori_produk.id";
$columnName["2"] = "kategori_produk.category_name";
...
$onCondition["1"] = ["subcategories.category_id", "kategori_produk.id"];
