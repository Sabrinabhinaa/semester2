...
if (isset($_POST['invoice_details'])) {
	...
	$columnName["7"] = "pesanan.shipcstmr_name";
	$columnName["8"] = "pesanan.shipcstmr_mobile";
	$columnName["9"] = "pesanan.shipcstmr_profession";
	$columnName["10"] = "pesanan.shipcstmr_streetadd";
	$columnName["11"] = "pesanan.shipcstmr_city";
	$columnName["12"] = "pesanan.shipcstmr_zip";
	$columnName["13"] = "pesanan.shipcstmr_country";
	...
	$onCondition["2"] = ["invoices.shipping_id", "pesanan.id"];
